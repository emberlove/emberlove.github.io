...
const PATHS: Record<string, string> = {
  ...
  'heart-fill': '<path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.29 1.49 4.04 3 5.5l7 7Z" fill="currentColor" stroke="none"/>',
  ...
  user: '<circle cx="12" cy="8" r="4"/><path d="M19 21v-1a6 6 0 0 0-6-6h-2a6 6 0 0 0-6 6v1"/>',
...
export function Icon({ name, size = 24, strokeWidth = 2, color = 'currentColor', style }: IconProps) {
